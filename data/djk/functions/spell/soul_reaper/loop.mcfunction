...
execute as @e[type=minecraft:armor_stand, tag=soul_reaper] at @s positioned ~ ~-2 ~ unless entity @e[type=!minecraft:armor_stand, tag=soul_reaper, distance=..2] run function djk:spell/soul_reaper/death

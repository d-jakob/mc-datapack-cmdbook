...
execute at @s[scores={cmd=41}] run function djk:currency/confwithdraw
...
execute at @s[scores={cmd=48}] run function djk:currency/balance
execute at @s[scores={cmd=49}] run function djk:currency/curselsetdigit/clear
